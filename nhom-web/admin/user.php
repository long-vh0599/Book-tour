                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="form-group">
                                        <a href="index.php?page_layout=edit_user&user_id=<?php echo $row['user_id']; ?>" class="btn btn-primary">Sửa</a>
                                        <a href="del_user.php?user_id=<?php echo $row['user_id']; ?>" class="btn btn-danger">Xóa</a>
                                    </td>
                                </tr>
                            <?php
                            }
